...
void Subdivision::Impl::subdivide(Subdivision * surf) {
    ...
    while (faceIt.hasNext()) {
        ...
        while (edgeIt.hasNext()) {
            ...
            size_t edgeMidPoint1 = size_t(edge1->userData());
            size_t edgeMidPoint2 = size_t(edge2->userData());
...
std::vector<size_t> Subdivision::selectedPoints() const {
    return _d->_selectedPoints;
}

void Subdivision::setSelectedPoints(const std::vector<size_t>& indicesArray) {
...
size_t Subdivision::edge(size_t iidVtxTail, size_t iidVtxHead) const
{
...
size_t Subdivision::addFace(const std::vector<size_t>& vertexIndexList)
{
    //NOT_IMPLEMENTED
...
void Subdivision::replaceFace(size_t /*faceIndex*/, const std::vector<size_t>& /*vertexIndexList*/)
{
    NOT_IMPLEMENTED
}
...
std::vector<size_t> Subdivision::getPointsInRadius(const Point3 &/*p*/, float /*radius*/) const
{
