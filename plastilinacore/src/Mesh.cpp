...
class MeshRenderer : public IRenderer
{
  ...
  public:
    ...
    void renderObject(std::shared_ptr<SceneNode>& node) { NOT_IMPLEMENTED; }
...
ISurface::size_t Mesh::iid() const { return _d->_iid; }
...
bool Mesh::hasChanged() { return _d->_hasChanged; }
...
void Mesh::setSelectedPoints(
    const std::vector<VertexHandle::size_t>& indicesArray)
{
    _d->_selectedPoints = indicesArray;
}

void Mesh::setScene(Scene* scene) { _d->_scene = scene; }

Scene* Mesh::scene() const { return _d->_scene; }

const IRenderable* Mesh::renderable() const { return this; }
...
const geometry::AABB& Mesh::boundingBox() const { return _d->_boundingBox; }

void Mesh::setColor(const Color& color) { _d->_color = color; }

Color Mesh::color() const { return _d->_color; }

void Mesh::setSelected(bool val) { _d->_selected = val; }

bool Mesh::isSelected() const { return _d->_selected; }
...
EdgeHandle::size_t Mesh::addEdge(VertexHandle::size_t v1,
...
FaceHandle::size_t
Mesh::addFace(const std::vector<VertexHandle::size_t>& vertexIndexList)
{
    // NOT_IMPLEMENTED
...
Mesh::getPointsInRadius(const Point3& /*p*/, float /*radius*/) const
{
...
void Mesh::adjustPointNormal(size_t /*index*/){NOT_IMPLEMENTED}
