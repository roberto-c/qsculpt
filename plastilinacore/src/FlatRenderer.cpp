...
struct FlatRenderer::Impl
{
    ...
    bool processPolygon(const Face& f, std::vector<FlatVtxStruct>& buffer,
                        size_t& pos);

    bool processTriangle(const Vertex& v1, const Vertex& v2, const Vertex& v3,
                         std::vector<FlatVtxStruct>& buffer, size_t& pos);
};
...
bool FlatRenderer::Impl::processTriangle(const Vertex& v1, const Vertex& v2,
                                         const Vertex&               v3,
                                         std::vector<FlatVtxStruct>& vtxData,
                                         size_t&                     offset)
{
