...
class DLLEXPORT SceneNode : public std::enable_shared_from_this<SceneNode>
{
  ...
  public:
    ...
    /**
     * Return the cumulative transformation from the root to the parent of
     * this node. It does not include this node transformation.
     */
    ...
    /**
     * Removes a node from this node. The node to remove must be a direct
