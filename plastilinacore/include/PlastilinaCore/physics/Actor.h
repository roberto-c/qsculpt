...
bool intersects(Actor::shared_ptr a1, Actor::shared_ptr a2,
                std::vector<IntersectionRec>* recs);

bool intersects(Plane::shared_ptr a1, Particle::shared_ptr a2,
                std::vector<IntersectionRec>* recs);
bool intersects(Plane::shared_ptr a1, Plane::shared_ptr a2,
                std::vector<IntersectionRec>* recs);
bool intersects(Plane::shared_ptr a1, Sphere::shared_ptr a2,
                std::vector<IntersectionRec>* recs);
bool intersects(Sphere::shared_ptr a1, Sphere::shared_ptr a2,
                std::vector<IntersectionRec>* recs);
};
